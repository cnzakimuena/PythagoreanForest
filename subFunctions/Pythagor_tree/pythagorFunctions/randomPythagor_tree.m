function M = randomPythagor_tree(n, nodeLevels, nodeAngles, nodeParents, Color1, Color2)
% function M = randomPythagor_tree(n, nodeLevels, nodeAngles, nodeParents, Color1, Color2)
% Compute randomPythagoras_tree
...
%
% Modified from the MATLAB implementation of the Pythagoras tree which
% can be found here:
%   https://www.mathworks.com/matlabcentral/fileexchange/26816-pythagoras-tree
...
%% Display the tree
Pythagor_tree_plot(M, n, Color1, Color2);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function H = Pythagor_tree_plot(D,d,color_1,color_2)

%     ColorM = ColorM_assigment(colorNum, d);
    % create a default color map ranging from color c1 to c2
    colormapSize = d+1;
    ColorM = [linspace(color_1(1),color_2(1),colormapSize)', linspace(color_1(2),color_2(2),colormapSize)', linspace(color_1(3),color_2(3),colormapSize)'];
